...
print ("The Ledgend of Zebra:")
print ("===================================================================")
print ("A long time ago. In a forrest far, far away.")
print ("the prince of darkness, Glanon stole the trinity of power.  '\n'The princess Glenn had the thinity of wisdom. '\n'Before being caught, she divided it into eight units to hide it from Glanon.")
print ("Find the 8 units 'OctoHero 'and rescue her.")
print ("Type 'help'")
